...
//#define _THINGSERVER "us-east.thethings.network"	// Server URL of the LoRa-udp.js handler
...
#define _DESCRIPTION "Oil Bees ESP Gateway"			// Name of the gateway
#define _EMAIL "nikkio101@hotmail.com"		// Owner
...
wpas wpa[] = {
	...
	{ "McClay Wi-Fi Network", "nickloveskay" },
	{ "ape", "beer" }
};
